    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <p>
                    Do you really want to delete this device ? <br />
                    It will both delete it from the sentinel device storage, but also publish proper messages to remove it from MQTT.
                </p>
                <hr />
                <p>This operation can not be undone! Proceed with caution.</p>
            </Modal>
        )
    }
}
